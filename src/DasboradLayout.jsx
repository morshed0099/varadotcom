...
const DasboradLayout = () => {
    ...
    return (
        <div>
            <div className='flex'>
                <div className={`w-[200px] text-white lg:ml-0 ml-[-200px] lg:flex   lg:flex-col gap-4 p-4  min-h-[100vh] bg-gray-800 duration-700 ease-in ${open && "ml-[0px] absolute duration-700 ease-in lg:static"}`}>
                    <div>
